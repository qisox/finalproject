...
<%@ include file="../common/header.jsp"%>
  	<br>
  <form class="row contact_form" action="insert.rere" method="post" id="contactForm" novalidate="novalidate" enctype="multipart/form-data">
    <div class="container">
      <div class="header">
      ...
      <div class="content">
        ...
        <div class="mb-4">
            ...
            <div class="rating-group">
                <input class="rating-input" id="interior-5-copy" type="radio" name="interiorScore" value="5"/>
                <label class="rating-label" for="interior-5-copy">★★★★★ 강력 추천</label>
    
                <input class="rating-input" id="interior-4-copy" type="radio" name="interiorScore" value="4"/>
                <label class="rating-label" for="interior-4-copy">★★★★ 추천</label>
    
                <input class="rating-input" id="interior-3-copy" type="radio" name="interiorScore" value="3"/>
                <label class="rating-label" for="interior-3-copy">★★★ 보통</label>
    
                <input class="rating-input" id="interior-2-copy" type="radio" name="interiorScore" value="2"/>
                <label class="rating-label" for="interior-2-copy">★★ 아쉬움</label>
    
                <input class="rating-input" id="interior-1-copy" type="radio" name="interiorScore" value="1" />
                <label class="rating-label" for="interior-1-copy">★ 실망</label>
            </div>
             <div class="rating-title">건물 별점</div>
            <div class="rating-group">
                <input class="rating-input" id="building-5-copy" type="radio" name="buildingScore" value="5"/>
                <label class="rating-label" for="building-5-copy">★★★★★ 강력 추천</label>
    
                <input class="rating-input" id="building-4-copy" type="radio" name="buildingScore" value="4"/>
                <label class="rating-label" for="building-4-copy">★★★★ 추천</label>
    
                <input class="rating-input" id="building-3-copy" type="radio" name="buildingScore" value="3"/>
                <label class="rating-label" for="building-3-copy">★★★ 보통</label>
    
                <input class="rating-input" id="building-2-copy" type="radio" name="buildingScore" value="2"/>
                <label class="rating-label" for="building-2-copy">★★ 아쉬움</label>
    
                <input class="rating-input" id="building-1-copy" type="radio" name="buildingScore" value="1" />
                <label class="rating-label" for="building-1-copy">★ 실망</label>
            </div>
             <div class="rating-title">교통 별점</div>
            <div class="rating-group">
                <input class="rating-input" id="traffic-5-copy" type="radio" name="trafficScore" value="5"/>
                <label class="rating-label" for="traffic-5-copy">★★★★★ 강력 추천</label>
    
                <input class="rating-input" id="traffic-4-copy" type="radio" name="trafficScore" value="4"/>
                <label class="rating-label" for="traffic-4-copy">★★★★ 추천</label>
    
                <input class="rating-input" id="traffic-3-copy" type="radio" name="trafficScore" value="3"/>
                <label class="rating-label" for="traffic-3-copy">★★★ 보통</label>
    
                <input class="rating-input" id="traffic-2-copy" type="radio" name="trafficScore" value="2"/>
                <label class="rating-label" for="traffic-2-copy">★★ 아쉬움</label>
    
                <input class="rating-input" id="traffic-1-copy" type="radio" name="trafficScore" value="1" />
                <label class="rating-label" for="traffic-1-copy">★ 실망</label>
            </div>
             <div class="rating-title">치안 별점</div>
            <div class="rating-group">
                <input class="rating-input" id="safety-5-copy" type="radio" name="safetyScore" value="5"/>
                <label class="rating-label" for="safety-5-copy">★★★★★ 강력 추천</label>
    
                <input class="rating-input" id="safety-4-copy" type="radio" name="safetyScore" value="4"/>
                <label class="rating-label" for="safety-4-copy">★★★★ 추천</label>
    
                <input class="rating-input" id="safety-3-copy" type="radio" name="safetyScore" value="3"/>
                <label class="rating-label" for="safety-3-copy">★★★ 보통</label>
    
                <input class="rating-input" id="safety-2-copy" type="radio" name="safetyScore" value="2"/>
                <label class="rating-label" for="safety2-copy">★★ 아쉬움</label>
    
                <input class="rating-input" id="safety-1-copy" type="radio" name="safetyScore" value="1" />
                <label class="rating-label" for="safety-1-copy">★ 실망</label>
            </div>
             <div class="rating-title">생활 별점</div>
            <div class="rating-group">
                <input class="rating-input" id="life-5-copy" type="radio" name="lifeScore" value="5"/>
                <label class="rating-label" for="life-5-copy">★★★★★ 강력 추천</label>
    
                <input class="rating-input" id="life-4-copy" type="radio" name="lifeScore" value="4"/>
                <label class="rating-label" for="life-4-copy">★★★★ 추천</label>
    
                <input class="rating-input" id="life-3-copy" type="radio" name="lifeScore" value="3"/>
                <label class="rating-label" for="life-3-copy">★★★ 보통</label>
    
                <input class="rating-input" id="life-2-copy" type="radio" name="lifeScore" value="2"/>
                <label class="rating-label" for="life-2-copy">★★ 아쉬움</label>
    
                <input class="rating-input" id="life-1-copy" type="radio" name="lifeScore" value="1" />
                <label class="rating-label" for="life-1-copy">★ 실망</label>
            </div>
             <div class="rating-title">총점</div>
            <div class="rating-group">
                <input class="rating-input" id="total-5-copy" type="radio" name="total" value="5"/>
                <label class="rating-label" for="total-5-copy">★★★★★ 강력 추천</label>
    
                <input class="rating-input" id="total-4-copy" type="radio" name="total" value="4"/>
                <label class="rating-label" for="total-4-copy">★★★★ 추천</label>
    
                <input class="rating-input" id="total-3-copy" type="radio" name="total" value="3"/>
                <label class="rating-label" for="total-3-copy">★★★ 보통</label>
    
                <input class="rating-input" id="total-2-copy" type="radio" name="total" value="2"/>
                <label class="rating-label" for="total-2-copy">★★ 아쉬움</label>
    
                <input class="rating-input" id="total-1-copy" type="radio" name="total" value="1" />
            ...
            <div class="type-group">
                <select name="rePeriod">
                	<option value="2023년까지">2023년까지</option>
                	<option value="2022년까지">2022년까지</option>
                	<option value="2021년까지">2021년까지</option>
                	<option value="2020년까지">2020년까지</option>
                	<option value="2019년까지">2019년까지</option>
                </select>
            </div>
...
<input type="hidden" name="consKeywords" id="consKeywords" value="">
       ...
       <input class="rebutton" value="작성하기" type="submit">
...
<script>
    function insertResidentReview() {
        ...
        var rePeriod=$("select[name='rePeriod']").val();
        var reFloor=$("select[name='reFloor']").val();
        ...
        $.ajax({
            ...
            success: function (result) {
            	console.log(result);
                if (result>0) {
                    location.href = "detail.ho?houseNo="+houseNo;
                } else {
                    alert("매물 리뷰 작성 실패: " + result.errorMsg);
                }
            },
            error: function () {
                console.log("매물 리뷰 통신 실패");
            },
            complete: function () {
                // 버튼 다시 활성화
